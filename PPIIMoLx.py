...
# ==========================================================
# >>>>>>>>    FUNCIÓN: WRAPPER_GENERAR_REPORTE_CSV    <<<<<<<<
# ==========================================================

"""
wrapper_generar_reporte_csv()
----------------------------------------------------------
Descripción:
    Función envoltorio utilizada en la interfaz gráfica para 
    ejecutar `generar_reporte_csv()` con los valores de ángulos 
    mínimo y máximo introducidos por el usuario. Valida la 
    entrada de datos desde los campos de texto y muestra 
    mensajes de error en caso de valores no numéricos.
...
# ==========================================================
# >>>>>>>>    FUNCIÓN: WRAPPER_CALCULAR_Y_VISUALIZAR    <<<<<<<<
# ==========================================================

"""
wrapper_calcular_y_visualizar()
----------------------------------------------------------
Descripción:
    Función envoltorio utilizada en la interfaz gráfica para 
    ejecutar `calcular_y_visualizar_distancias()` con los valores 
    de ángulo mínimo y máximo introducidos por el usuario. Valida 
    los datos ingresados en los campos de texto y muestra mensajes 
    de error si las entradas no son numéricas.
